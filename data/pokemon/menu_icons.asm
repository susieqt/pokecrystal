...
MonMenuIcons:
	...
	db ICON_GHOST       ; SANDSHREW
	db ICON_GHOST       ; SANDSLASH
	...
	db ICON_FIGHTER     ; GROWLITHE
	db ICON_FOX         ; ARCANINE
	db ICON_FISH        ; POLIWAG
	db ICON_FISH        ; POLIWHIRL
	db ICON_FISH        ; POLIWRATH
	...
	db ICON_POLIWAG     ; CUBONE
	db ICON_POLIWAG     ; MAROWAK

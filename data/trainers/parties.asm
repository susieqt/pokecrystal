...
WhitneyGroup:
	...
	db 18, CLEFAIRY,   DOUBLESLAP, METRONOME, ENCORE, METRONOME
...
MortyGroup:
	...
	db 21, HAUNTER,    HYPNOSIS, METRONOME, CURSE, NIGHT_SHADE
	db 25, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 23, HAUNTER,    SPITE, MEAN_LOOK, METRONOME, NIGHT_SHADE
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 38, PIDGEOT,    SWIFT, DETECT, IRON_HEAD, FLY
	db -1 ; end

...
MapGroup_NewBark:
	...
	map CherrygroveMart, TILESET_MART, INDOOR, NEW_BARK_TOWN, MUSIC_SHOP, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cherrygrove:
	...
	map MrPokemonsHouse, TILESET_FACILITY, INDOOR, ROUTE_30, MUSIC_CINNABARMANSION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
